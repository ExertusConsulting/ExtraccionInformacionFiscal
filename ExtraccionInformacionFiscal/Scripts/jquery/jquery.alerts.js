...
(function($) {
	...
	$.alerts = {
		...
		overlayColor: '#B2B2B2',            // base color of overlay
		...
		_show: function(title, msg, value, type, callback) {
            ...
            */
			...
			switch( type ) {
				case 'alert':
				    $("#popup_message").after('<div id="popup_panel"> <button id="popup_ok" class="alabel">' + $.alerts.okButton + '</button> </div>');
				...
				break;
				case 'confirm':
				    $("#popup_message").after('<div id="popup_panel"><button id="popup_ok" class="alabel">' + $.alerts.okButton + '</button> <button id="popup_cancel" class="alabel">' + $.alerts.cancelButton + '</button>  </div>');
					$("#popup_ok").click( function() {
						$.alerts._hide();
